...
public class bureau  implements Fabrication{
	...
	public boolean expedierHomeDepot() {
		// TODO Auto-generated method stub
		System.out.println("Bureau:En expedition vers HomeDepot");
		return true;
	}
	...
	public boolean expedierRona() {
		// TODO Auto-generated method stub
		System.out.println("Bureau:En expedition vers Rona");
		return true;
	}
	...
	public boolean expedierCanadianTire() {
		// TODO Auto-generated method stub
		System.out.println("Bureau:En expedition vers Canadian Tire");
		return true;
	}
